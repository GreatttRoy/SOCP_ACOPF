...
def case33(t=0):
    ...
    ppc["branch"] = array([
        ...
        #[33, 31, 0.3410, 0.5302, 0, 0, 0, 0, 0, 0, 1, -360, 360], # 构造一个小环
    ])
    ...
    ## DR load data
    # bus, Pd, Qd, Qmax, Qmin, Vd, mBase, status, Pmax, Pmin, Pc1, Pc2,
    ...
    Vbase = ppc["bus"][0][BASE_KV] * 1e3  # in Volts
    Sbase = ppc["baseMVA"] * 1e6  # in VA
    for branch in ppc["branch"]:
        branch[BR_R] /= (Vbase ** 2 / Sbase)
        branch[BR_X] /= (Vbase ** 2 / Sbase)
